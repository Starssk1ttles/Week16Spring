...
public interface JeepSalesController {
  ...
  @Operation(
      summary ="Summary of Jeep",
      description = "Yo description of jeep",
      responses = {
          @ApiResponse(responseCode = "200", description = "Good", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Jeep.class))),
      ...
      parameters = {
          @Parameter(name = "model", allowEmptyValue = false, required = false, description = "Model name"),
          @Parameter(name = "trim", allowEmptyValue = false, required = false, description = "Trim")
      }
      )
